...
export const AssetListItem = ({name, model, image}: AssetListItemProps) => {
  ...
  return (
    <Flex flexDirection="row" flexWrap="wrap" cursor="pointer" onClick={() => navigate('/assets/1')} justifyContent="space-between" alignItems="center" paddingX="20px" paddingY="25px" width="100%" borderBottom="1px solid #D7D7D7" >
      ...
      <Flex alignItems="center" gap={{base: '2', lg: '10'}} justifyContent="space-between" mt={{base: '3', md: 'unset'}} width={{base: "100%", sm: "100%", md: "auto", lg: "auto", xl: "auto"}}>
        <Box bg="#ED3833" py="1" width="80px" textAlign="center" borderRadius="5" color="#FFF">
          <Text as="b" fontSize="sm">49%</Text>
        </Box>
        <Box bg="#52C41A" py="1" width="100px" textAlign="center" borderRadius="5" color="#FFF">
          <Text as="b" fontSize="sm">In Operation</Text>
        </Box>
