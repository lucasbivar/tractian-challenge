...
export const categoryLabels: ICategoryLabels = {
	unit: {
		...
		errorEditMessage: "Cannot edit the unit! Fill the fields correctly.",
		successCreateMessage: "Unit created successfully!",
		errorCreateMessage: "Cannot create the unit! Fill the fields correctly.",
	},
	company: {
		entity: "Company",
		...
		errorEditMessage: "Cannot edit the company! Fill the fields correctly.",
		successCreateMessage: "Company created successfully!",
		errorCreateMessage: "Cannot create the company! Fill the fields correctly.",
	},
	user: {
		entity: "User",
		...
		errorEditMessage: "Cannot edit the user! Fill the fields correctly.",
		successCreateMessage: "User created successfully!",
		errorCreateMessage: "Cannot create the user! Fill the fields correctly.",
	},
	asset: {
		entity: "Asset",
		...
		errorEditMessage: "Cannot edit the asset! Fill the fields correctly.",
		successCreateMessage: "Asset created successfully!",
		errorCreateMessage: "Cannot create the asset! Fill the fields correctly.",
	},
	workOrder: {
		entity: "Work Order",
		...
		errorEditMessage: "Cannot edit the work order! Fill the fields correctly.",
		successCreateMessage: "Work Order created successfully!",
		errorCreateMessage:
			"Cannot create the work order! Fill the fields correctly.",
	},
};
